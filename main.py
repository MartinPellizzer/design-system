...
html_colors += f'<p>color | brand | blue</p>'
...
# ;color_grey
html_colors += f'<section style="margin-bottom: 96px;">'
html_colors += f'<p>color | brand | grey</p>'
html_colors += f'<div style="display: flex;">'
html_colors += f'''
    <div style="display: flex; flex-direction: column;">
...
'''
html_t1_filepath = 'public/t1.html'
with open(html_t1_filepath, 'w') as f: f.write(html_t1)
...
'''
html_t2_filepath = 'public/t2.html'
with open(html_t2_filepath, 'w') as f: f.write(html_t2)
...
'''
html_t3_filepath = 'public/t3.html'
with open(html_t3_filepath, 'w') as f: f.write(html_t3)
